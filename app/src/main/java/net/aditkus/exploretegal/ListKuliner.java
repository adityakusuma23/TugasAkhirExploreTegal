...
import net.aditkus.exploretegal.ViewHolder.FoodViewHolder;
            ...
            protected void populateViewHolder(FoodViewHolder viewHolder, Food model, int position) {
                ...
                viewHolder.setItemClickListener(new ItemClickListener(){
                    ...
                    public void onClick(View view, int position, boolean isLongClick) {
                        //mulai activity baru
                        Intent foodDetail= new Intent(ListKuliner.this,FoodDetail.class);

                        foodDetail.putExtra("FoodId",adapter.getRef(position).getKey());//mengirim food ke activity baru
